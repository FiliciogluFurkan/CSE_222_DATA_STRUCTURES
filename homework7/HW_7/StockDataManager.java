...
public class StockDataManager {
    ...
    public void updateStock(String symbol,String symbol2, double newPrice, long newVolume, long newMarketCap) {
        Stock stock = avlTree.search(symbol);
        if (stock != null) {
            stock.setSymbol(symbol2);
    ...
    System.out.println();
    avlTree.preOrderTraveresal();
    System.out.println();
    avlTree.postOrderTraveresal();
    }
